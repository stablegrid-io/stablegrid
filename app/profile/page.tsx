...
import type { ProfileRecord, SubscriptionRecord } from '../settings/_components/types';

export const metadata: Metadata = {
  title: 'Profile — stableGrid.io',
  description: 'Your account settings, avatar, and subscription.'
};
