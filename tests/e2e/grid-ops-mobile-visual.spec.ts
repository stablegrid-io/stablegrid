...
test.describe('grid ops visual mobile baseline', () => {
  ...
  test('mobile reduced scene baseline', async ({ page }) => {
    ...
    await expect(page.locator('main')).toHaveScreenshot('grid-ops-mobile.png', {
