-- Fix: "column reference items_owned is ambiguous" in grid_purchase.
-- The UPDATE's SET list is resolved against both the table columns and
-- the PL/pgSQL row variable v_state. Qualify with table alias.
