# QA P0 GitHub Issue Drafts

These are ready-to-create issue bodies for the `stablegrid` repo.

## Issue 1

Title:
`[QA-P0-001] Align launch messaging to Theory Beta scope`
...
Title:
`[QA-P0-002] Enforce theory-only navigation for beta launch`
...
Title:
`[QA-P0-003] Define and enforce auth policy for Theory and app routes`
...
Title:
`[QA-P0-004] Verify Theory progress durability end-to-end`
...
Title:
`[QA-P0-005] Restore green release gates (lint + test + e2e key/theory)`
...
Title:
`[QA-P0-006] Lock analytics funnel contract for Theory beta`
...
Title:
`[QA-P0-007] Validate Theory error-state handling and recovery`
