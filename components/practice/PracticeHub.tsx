...
const CATEGORIES: Category[] = [
  {
    ...
    imageFilter: 'brightness(0.4) contrast(1.1) hue-rotate(160deg) saturate(0.6)',
  ...
  },
  {
    ...
    imageFilter: 'brightness(0.4) contrast(1.1) hue-rotate(240deg) saturate(0.5)',
    href: '/practice/logic',
  },
  {
    id: 'math-statistics',
    ...
    imageFilter: 'brightness(0.4) contrast(1.1) hue-rotate(30deg) saturate(0.7)',
  ...
  },
  {
    ...
    comingSoon: true,
    image: '/brand/track-junior.png',
    imageFilter: 'brightness(0.35) contrast(1.1) hue-rotate(-30deg) saturate(0.6)',
  ...
  },
  {
    ...
    comingSoon: true,
    image: '/brand/track-mid.png',
    imageFilter: 'brightness(0.35) contrast(1.1) hue-rotate(80deg) saturate(0.5)',
