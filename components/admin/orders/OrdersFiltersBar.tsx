      ...
      <div className="flex flex-wrap items-start justify-between gap-3">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <button
            type="button"
            onClick={onNewOrder}
            className="inline-flex h-10 items-center gap-2  border border-brand-300/35 bg-primary/90 px-3.5 text-sm font-semibold text-[#06110d] shadow-[0_14px_28px_-20px_rgba(34,185,153,0.52)] transition hover:bg-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-400/40"
          >
