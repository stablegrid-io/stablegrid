      ...
      <div className="flex flex-wrap items-center gap-2 md:justify-end">
        <label className="inline-flex items-center gap-2 font-data-mono text-[10px] tracking-[0.16em] uppercase text-on-surface-variant font-semibold">
          ...
          <select
            ...
            className="h-9 px-2.5 border border-surface-dim bg-surface text-[12px] font-data-mono text-on-surface outline-none transition focus:border-primary focus:ring-2 focus:ring-primary/30"
          >
        ...
        <button
          ...
          disabled={page <= 1}
          className={`${ADMIN_GHOST_BUTTON_CLASS} gap-1 disabled:cursor-not-allowed disabled:opacity-40`}
        >
        ...
        {pageNumbers.map((value) => {
          ...
          return (
            <button
              ...
              className={`inline-flex h-8 min-w-8 items-center justify-center px-2 border transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/40 ${
                isCurrent
