...
const FIELD_CLASS = ' border border-on-surface/[0.08] bg-on-surface/[0.03] p-4';
const LABEL_CLASS = 'font-mono text-[10px] uppercase tracking-[0.18em] text-on-surface/45';
const PILL_CLASS =
      ...
      >
        <div className="flex items-start justify-between gap-4">
          <div className="min-w-0">
            ...
            <p className="mt-1.5 text-[13px] text-on-surface/60 truncate">
        ...
        <div className="mt-5 flex flex-wrap gap-2">
          ...
          <span
            className="inline-flex h-6 items-center rounded-full border border-on-surface/[0.12] bg-on-surface/[0.04] px-2.5 font-mono text-[10px] font-semibold tracking-[0.12em] uppercase text-on-surface/60 tabular-nums"
          >
        ...
        <div className="mt-6 grid gap-3 sm:grid-cols-2">
          <div className={FIELD_CLASS}>
            ...
            <p className="mt-2 text-[13px] text-on-surface/85 font-mono tabular-nums">
              {formatFeedbackDate(record.submittedAt)}
            </p>
          </div>
          <div className={FIELD_CLASS}>
            <p className={LABEL_CLASS}>Category</p>
            <p className="mt-2 text-[13px] text-on-surface/85">{record.category}</p>
          </div>
          <div className={FIELD_CLASS}>
            <p className={LABEL_CLASS}>Product area</p>
            <p className="mt-2 text-[13px] text-on-surface/85">{record.module}</p>
          </div>
          <div className={FIELD_CLASS}>
            <p className={LABEL_CLASS}>Linked page</p>
            <p className="mt-2 break-all text-[13px] text-on-surface/85 font-mono">
              {record.linkedPage}
            </p>
          </div>
        </div>
        ...
        <div className="mt-4 border border-on-surface/[0.08] bg-on-surface/[0.03] p-5">
          ...
          <p className="mt-3 text-[13px] leading-7 text-on-surface/80 whitespace-pre-wrap">
            {record.message}
          </p>
        </div>
        ...
        <div className="mt-4 border border-on-surface/[0.08] bg-on-surface/[0.03] p-5">
          <div className="flex items-center justify-between gap-3">
            <div>
              ...
              <p className="mt-2 text-[12px] text-on-surface/45 leading-relaxed">
          ...
          {record.keywords.length > 0 ? (
            <div className="mt-4 flex flex-wrap gap-1.5">
              {record.keywords.map((keyword) => (
                <span
                  key={keyword}
                  className="inline-flex items-center rounded-full border border-on-surface/[0.1] bg-on-surface/[0.04] px-2.5 py-1 font-mono text-[10px] font-semibold tracking-[0.1em] uppercase text-on-surface/60"
                >
                  {keyword}
                </span>
              ))}
        ...
        <div className="mt-4 border border-on-surface/[0.08] bg-on-surface/[0.03] p-5">
          ...
          <textarea
            ...
            rows={6}
            className="mt-3 w-full px-3 py-3 text-[13px] leading-relaxed text-on-surface outline-none transition-all placeholder:text-on-surface/30 focus:ring-2 focus:ring-[rgba(153,247,255,0.15)]"
            style={{
              background: 'rgba(255,255,255,0.04)',
              border: '1px solid rgba(255,255,255,0.1)',
            }}
        ...
        <div className="mt-6 flex items-center justify-end gap-2">
          <button
            type="button"
            onClick={onClose}
            className="inline-flex h-9 items-center px-4 transition-all hover:bg-on-surface/[0.07]"
            style={{
              borderRadius: 10,
              background: 'rgba(255,255,255,0.04)',
              border: '1px solid rgba(255,255,255,0.1)',
