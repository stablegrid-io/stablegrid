        ...
        <div className="relative w-full max-w-[400px] rounded-[22px] bg-[#111416] border border-white/[0.06] p-8">
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full h-12 flex items-center justify-center gap-3 rounded-[14px] border border-white/[0.08] bg-white/[0.03] text-[14px] font-medium text-on-surface transition-all hover:bg-white/[0.06] hover:border-white/[0.12] active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {loading === 'google' ? (
          ...
          {/* Footer */}
          <p className="mt-6 text-center text-[11px] text-on-surface-variant/30">
