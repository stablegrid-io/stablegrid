        ...
        <section className="flex items-center justify-center bg-[#f8fbf9] px-5 py-10 sm:px-8 lg:px-14">
          <div className="w-full max-w-md">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <div className="mb-1.5 flex items-center justify-between">
                  ...
                  <Link
                    href="/reset-password"
                    className="text-xs font-semibold text-[#111111] underline underline-offset-2 transition-colors hover:text-[#137763]"
                  >
                    Forgot password?
                  </Link>
                </div>
            ...
            <p className="mt-5 text-center text-sm text-[#9a9a9a]">
              ...
              <Link href="/signup" className="font-semibold text-[#137763] hover:underline">
                Sign up free
              </Link>
            </p>
            <p className="mt-3 text-center text-xs text-[#8f8f8f]">
              <Link href="/privacy" className="hover:text-[#137763] hover:underline">
                Privacy
              </Link>
              {' · '}
              <Link href="/terms" className="hover:text-[#137763] hover:underline">
                Terms
              </Link>
              {' · '}
              <Link href="/support" className="hover:text-[#137763] hover:underline">
                Support
              </Link>
            </p>
          </div>
