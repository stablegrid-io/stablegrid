...
const CONTROL_CENTER_MODEL_URL =
  resolveSceneAssetDescriptor('control-center')?.url ??
  '/grid-assets/models/high-poly-archive/control-center.glb?v=high-poly-v1';
...
useGLTF.preload(CONTROL_CENTER_MODEL_URL);
