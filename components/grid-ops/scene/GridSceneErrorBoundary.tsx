...
> {
  ...
  render() {
    ...
    return (
      <section className="flex h-[58vh] min-h-[520px] w-full items-center justify-center rounded-2xl border border-amber-500/40 bg-[#0a1511] p-6 text-center text-[#dceee5]">
        <div>
          ...
          <p className="mt-2 text-sm text-[#b7d1c4]">
            Reload the page to retry the 2.5D renderer.
          </p>
          <button
            type="button"
            onClick={this.handleReload}
            className="mt-4 inline-flex items-center gap-2 rounded-lg border border-[#335f4f] bg-[#10211a] px-3 py-1.5 text-sm font-medium text-[#def3e8] transition hover:border-emerald-400/70"
          >
