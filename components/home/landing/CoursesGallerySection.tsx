    ...
    <section id="courses-gallery" className="border-t border-[#242c33] py-20">
      <div className="mx-auto max-w-6xl px-6">
        <div className="mb-10 text-center">
          <p className="mb-3 text-[11px] font-semibold uppercase tracking-[0.18em] text-[#a5b0ba]">
            Course Gallery
          </p>
            ...
            const cardBody = (
              ...
              >
                ...
                {course.locked ? (
                  ...
                  <p className="relative mt-3 text-xs font-semibold uppercase tracking-[0.12em] text-[#c5ced6]">
                    Open track
                  </p>
                )}
              </article>
