    ...
    <section className="border-t border-[#1a2a22] py-24">
      <div className="mx-auto max-w-2xl px-6 text-center">
        <h2 className="mb-4 text-4xl font-bold text-[#e3efe8]" style={{ fontFamily: 'Georgia, serif' }}>
          Build operational judgment.
          <br />
          Not just course completion.
        </h2>
        <p className="mb-8 text-lg text-[#9ab8a9]">
          Train through grid incidents, earn deployment authority, and make progress visible on a live system instead of a static lesson checklist.
        </p>
        <Link
          href="/signup"
