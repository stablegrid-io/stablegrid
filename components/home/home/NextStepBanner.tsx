  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-col gap-4 lg:flex-row lg:items-center">
        <div
          className="inline-flex h-12 w-12 flex-shrink-0 items-center justify-center text-xl text-on-surface"
          style={{
        ...
        <div className="min-w-0 flex-1">
          <p className="text-[11px] font-mono font-bold uppercase tracking-[0.18em] text-[#0f8a5c]">
            Continue learning
          </p>
          <p className="mt-2 text-xl font-semibold tracking-tight text-[#121b18] #f2f7f4]">
            Resume {meta.label} chapter {session.chapterNumber}
          </p>
          <p className="mt-2 max-w-2xl text-sm leading-6 text-[#5d655f] #8aa496]">
        ...
        <div className="flex flex-col gap-3 sm:flex-row">
          <div className="rounded-full border border-[#d9cfbf] bg-[rgba(255,255,255,0.7)] px-3 py-2 text-xs font-medium text-[#47544f] (255,255,255,0.03)] #8aa496]">
            {completion}% complete
          </div>
          <Link
            href="/theory"
