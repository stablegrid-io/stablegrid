            ...
            >
              <div className="mb-3 flex items-start justify-between gap-3">
                <div className="flex items-center gap-2.5">
                  ...
                  <span>
                    <span className="block text-sm font-semibold text-[#121b18] #f2f7f4]">
                      {topic.meta.label}
                    </span>
                    <span className="block text-xs text-[#6d746f] #7e9589]">
                      {topic.chaptersCompleted}/{topic.chaptersTotal} chapters completed
                    </span>
                  </span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="rounded-full bg-[#f1ede5] px-2 py-1 text-[11px] text-[#56635c] #8aa496]">
                    {status}
                  </span>
                  <ChevronRight className="h-3.5 w-3.5 text-[#6d746f] transition-transform group-hover:translate-x-0.5 #7e9589]" />
                </div>
              </div>
...
const ProgressRow = ({
  ...
  <div className="grid grid-cols-[46px_1fr_auto] items-center gap-2">
    <span className="text-[10px] font-mono font-bold uppercase tracking-[0.12em] text-[#6d746f] #7e9589]">
      {label}
    </span>
    ...
    <span className="text-[10px] text-[#6d746f] #7e9589]">{value}</span>
  </div>
);
